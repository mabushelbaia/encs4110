...
\def\ExpTitle{%
  \ifcase\EXPNUM
    \or Introduction to ARM Cortex-M4 Assembly%
    \or Instruction Set and Addressing Modes%
    \or Flow Control, Procedures, and Stack Management%
    \or TM4C123 Architecture and Digital I\/O%
    \or GPIO Input and Hardware Interrupts%
    \or System Timers and General-Purpose Timer Modules%
    \or LCD Interfacing and Display Control%
    \or Analog-to-Digital Conversion (ADC)%
    \or UART Serial Communication%
  \fi
}
\makeatother
