...
\hypersetup{
  ...
  bookmarksnumbered=true  % add numbers to PDF bookmarks
}
...
\usepackage{adjustbox} % in your preamble
\usepackage{circuitikz}


\makeatletter
\newcommand\miniscule{\@setfontsize\miniscule{4}{5}} % 5pt font, 6pt baseline skip
\makeatother
