...
# Flow Control, Procedures, and Stack Management
...
```
::: info Note
The `PROC` and `ENDP` directives help define the start and end of a procedure and they could be safely omitted.
:::
...
<img src="/push.svg" alt="Stack Push Operation" width="80%">

**Figure 1. Stack operation sequence for `PUSH {R4, R0, R2, LR}`**
...
<img src="/pop.svg" alt="Stack Pop Operation" width="80%">

**Figure 2. Stack operation sequence for `POP {R6-R8}`**
