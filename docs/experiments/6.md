...
# Task 2: Multiple Timers
Use three external LEDs with the TM4C123G board so that:
- The RED LED blinks every 1 second.
- The BLUE LED blinks every 5 seconds.
- The GREEN LED blinks every 10 seconds.